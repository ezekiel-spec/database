...
-- 5. Seed data for classification
INSERT INTO public.classification (classification_name)
VALUES ('Custom'), ('Sport'), ('SUV'), ('Truck'), ('Sedan');

-- 6. Seed data for inventory
...
VALUES 
    ...
    ('GM', 'Hummer', '2016', 'The Hummer gives you the small interiors with an engine to get you out of any muddy or rocky situation.', '/images/hummer.jpg', '/images/hummer-tn.jpg', 58800, 56564, 'Yellow', 4),
...
-- 7. Final Assignment Modifications (Task 1 Queries 4 & 6)
-- Modification to GM Hummer description
UPDATE public.inventory 
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Update all image and thumbnail paths
UPDATE public.inventory 
